...
INFO_CHOICES = (
    ...
    (11, 'Информация о выделенных (созданных) рабочих местах для трудоустройства инвалидов в соответствии с установленной квотой для приема на работу инвалидов и о локальных нормативных актах, содержащих сведения о данных рабочих местах'),
    (12, 'Информация о выполнении квоты для приема на работу инвалидов'),
)
