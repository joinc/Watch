...
INFO_CHOICES = (
    ...
    (
        5,
        'Введение режима неполного рабочего дня (смены) и (или) неполной рабочей недели, а также приостановка '
        'производства',
    ),
    (
        6,
    ...
    (
        7,
        'Информация, необходимая для осуществления деятельности по профессиональной реабилитации и содействию '
        'занятости инвалидов',
    ),
    (
        8,
    ...
    (
        9,
        'Информация о наличии свободных рабочих мест и вакантных должностей созданных или выделенных рабочих '
        'местах для трудоустройства инвалидов в соответствии с установленной квотой для приема на работу инвалидов',
    ),
    (
        10,
        'Информация о свободных рабочих местах или вакантных должностях, содержащая ограничения дискриминационного '
        'характера',
    ),
    (
        11,
        'Информация о выделенных (созданных) рабочих местах для трудоустройства инвалидов в соответствии с '
        'установленной квотой для приема на работу инвалидов и о локальных нормативных актах, содержащих сведения о '
        'данных рабочих местах',
    ),
    (
        12,
